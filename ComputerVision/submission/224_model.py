...
model.train()
model.load_state_dict(torch.load(f'/cs/home/akhkr1/Documents/224_400_epochs/syn_model.pt'))
...
for epoch in range(epochs):
    ...
    with open('/cs/home/akhkr1/Documents/224_logs.txt', 'a') as f:
...
with open(f'/cs/home/akhkr1/Documents/{folder_name}/syn_model.txt', 'a') as model_file:
    model_file.write(f'Linear, softplus, 3 layers, 1024_2_2, with Scaled scale invariant exponential loss. Input 257*384, output 224*224, lr=1e-4, run {epochs} times of {batch_size} batch size')