...
python scripts/train.py --model-type random_forest --data data/train/ --save models/part3_forest.pt 
python scripts/evaluate.py --model models/part3_forest.pt --data data/test/
echo ""
